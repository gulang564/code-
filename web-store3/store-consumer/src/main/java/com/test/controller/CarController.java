...
public class CarController {
    ...
    public Result AddCarServlet(@ApiParam OrderDto orderDto) {
        boolean b = carService.addCar(orderDto);
        return b ? Result.success(b) : Result.fail500(b);
    }
    ...
    public Result showCar(Integer uId) {
        ...
        return map.size() > 0 ? Result.success(map) : new Result(400, "没有添加购物车", null);
    }
